...
<div class="max-w-2xl mx-auto py-10 sm:px-6 lg:px-8">
    <div class="bg-white shadow rounded-lg p-6">
        <h2 class="text-xl font-bold mb-4">Editar Asignatura</h2>
            ...
            <div class="mb-4">
                ...
                <select name="id_programa" id="id_programa"
                    ...
                    @foreach($programas as $programa)
                        <option value="{{ $programa->id_programa }}" {{ (old('id_programa', $asignatura->id_programa) == $programa->id_programa) ? 'selected' : '' }}>
                            {{ $programa->nombre }}
                        </option>
                    @endforeach
                </select>
