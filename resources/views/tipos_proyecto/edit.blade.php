...
<div class="max-w-2xl mx-auto py-10 sm:px-6 lg:px-8">
    <div class="bg-white shadow rounded-lg p-6">
        <h2 class="text-xl font-bold mb-4">Editar Tipo de Proyecto</h2>
        <form action="{{ route('tipos_proyecto.update', $tipos_proyecto) }}" method="POST">
            @csrf
            @method('PUT')
            <div class="mb-4">
                ...
                <input type="text" name="nombre" id="nombre"
                    ...
                    value="{{ old('nombre', $tipos_proyecto->nombre) }}" required>
                @error('nombre')
